      ...
      <div className="container px-6 py-12 mx-auto">
        ...
        >
          <div className="relative mb-6">
            ...
            >
              <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="60" cy="60" r="58" fill="#FEF2F2" stroke="#FCA5A5" strokeWidth="2"/>
                <circle cx="60" cy="60" r="44" fill="#FEE2E2"/>
                <path d="M60 35 L60 68" stroke="#EF4444" strokeWidth="6" strokeLinecap="round"/>
                <circle cx="60" cy="82" r="4" fill="#EF4444"/>
                {/* Decorative sparks */}
                <path d="M25 25 L30 35 L20 30Z" fill="#FCA5A5" opacity="0.7"/>
                <path d="M95 25 L90 35 L100 30Z" fill="#FCA5A5" opacity="0.7"/>
                <circle cx="18" cy="60" r="5" fill="#FCA5A5" opacity="0.5"/>
                <circle cx="102" cy="60" r="5" fill="#FCA5A5" opacity="0.5"/>
                <path d="M25 95 L30 85 L35 95Z" fill="#FCA5A5" opacity="0.5"/>
                <path d="M95 95 L90 85 L85 95Z" fill="#FCA5A5" opacity="0.5"/>
              </svg>
            </motion.div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full">
            ...
            >
              <HiOutlineArrowLeft size={20} className="text-blue-500" />
              Go Back
            </button>

            <div className="w-full sm:w-56 shadow-xl shadow-blue-500/20 rounded-2xl overflow-hidden active:scale-95 transition-transform">
              <Button
                label={
