      ...
      >
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="md:col-span-1">
              ...
              <select
                ...
                className="w-full mt-1.5 px-4 py-3.5 rounded-2xl border border-gray-500/50 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all appearance-none cursor-pointer"
              >
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-blue-700 hover:bg-blue-600 text-white/80 py-4 rounded-2xl font-bold text-lg shadow shadow-blue-500/30 active:scale-[0.98] transition-all disabled:opacity-70 mt-4"
          >
        ...
        <div className="relative my-10">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-blue-500 rounded-2xl px-4 text-white/80 font-bold tracking-[0.2em]">Or use social</span>
          </div>
        </div>

        <button
          onClick={handleGoogleSignIn}
          className="flex w-full items-center justify-center gap-3 border border-gray-500/50 py-4 rounded-2xl font-bold text-gray-500 hover:bg-blue-700 hover:text-white/80 transition-all active:scale-[0.98]"
        >
          <FcGoogle size={24} />
          Sign up with Google
        </button>
