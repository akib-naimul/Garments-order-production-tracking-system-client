            ...
            <Container>
                <div className="text-center mb-10">
                    ...
                    >
                        ...
                        <span className="text-blue-600 italic">Great Together</span>
                    </motion.h1>
                    <motion.p
                        initial={{ opacity: 0 }}
                        ...
                        >
                            <div className="grid md:grid-cols-2 gap-6 mb-6">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className={`w-full  border ${errors.name ? 'border-red-400' : 'border-gray-500/50'} p-4 rounded-2xl  focus:border-blue-500 transition-all outline-none`}
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full border border-gray-500/50 p-4 rounded-2xl  focus:border-blue-500 transition-all outline-none"
                            ...
                            <div className="grid md:grid-cols-2 gap-6 mb-6">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        {...register("phone")}
                                        className="w-full border-2 border-gray-500/50 p-4 rounded-2xl focus:border-blue-500 transition-all outline-none"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <select
                                        {...register("subject")}
                                        className="w-full border border-gray-500/50 p-4 rounded-2xl  focus:border-blue-500 transition-all outline-none appearance-none"
                                    >
                            ...
                            <div className="space-y-2 mb-8">
                                ...
                                <textarea
                                    ...
                                    className="w-full border border-gray-500/50 p-4 rounded-2xl focus:border-blue-500 transition-all outline-none resize-none"
                            ...
                            <button
                                disabled={loading}
                                type="submit"
                                className={`w-full ${loading ? 'bg-gray-400' : 'bg-blue-600 hover:bg-gray-500'} text-white py-4 rounded-2xl font-bold transition-all shadow-lg flex items-center justify-center gap-3 group`}
                            >
                                {loading ? (
...
const SocialIcon = ({ icon, link }) => (
    <a
        href={link}
        className="w-12 h-12 shadow rounded-xl flex items-center justify-center text-gray-500 hover:bg-blue-600 hover:text-white hover:-translate-y-1 transition-all duration-300"
    >
        {icon}
    </a>
);
