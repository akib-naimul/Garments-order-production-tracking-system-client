            ...
            <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                        ...
                        <div className="md:col-span-5 relative">
                            ...
                            <input
                                ...
                                className="w-full pl-11 pr-4 py-3  border border-gray-500/50 rounded-2xl focus:ring-2 focus:ring-blue-400 transition-all outline-none"
                            />
                        </div>
                ...
                <div className="mb-6 px-2 flex justify-between items-center">
                    <p className="font-bold">
                        Total Products (<span className="text-blue-600 font-bold">{filtered.length})</span>
                    </p>
                </div>
                ...
                {totalPages > 1 && (
                    <div className="flex justify-center items-center gap-3 mt-16">
                        <button
                            ...
                            className="px-5 py-2.5 rounded-xl font-bold bg-white/80 border border-gray-200/50 text-gray-600 hover:bg-blue-500 hover:text-white disabled:opacity-50 disabled:hover:bg-white disabled:hover:text-gray-600 transition-all shadow-sm"
                        >
                            Previous
                        </button>
                        ...
                        <button
                            ...
                            onClick={() => setCurrentPage(prev => prev + 1)}
                            className="px-5 py-2.5 rounded-xl font-bold bg-white/80 border border-gray-200/50 text-gray-600 hover:bg-blue-500 hover:text-white/90 disabled:opacity-50 transition-all shadow-sm"
                        >
                            Next
                        </button>
                    </div>
