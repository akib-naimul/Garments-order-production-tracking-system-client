            ...
            <Container>
                ...
                >
                    <div className="relative z-10">
                        <span className="bg-blue-100 text-blue-700 px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-[0.2em] mb-4 inline-block">
                            Digitalized Workflow
                        </span>
                        <h2 className="text-4xl md:text-5xl font-black  mb-6 leading-tight">
                            Garments Order & <br />
                            <span className="text-blue-600 underline decoration-blue-700 decoration-4">Production Tracker System</span>
                        </h2>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
                    {[
                        ...
                        >
                            <div className="text-blue-600 text-3xl mb-2 flex justify-center">{stat.icon}</div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-16">
                    <motion.div
                        {...fadeInUp}
                        className=" p-10 rounded-[3rem] shadow border border-blue-500/50 group"
                    >
                        <div className="w-14 h-14 bg-blue-600 text-white rounded-2xl flex items-center justify-center mb-6 shadow shadow-blue-200 group-hover:rotate-12 transition-transform">
                    ...
                    <motion.div
                        ...
                        className=" p-10 rounded-[3rem] shadow-sm border border-blue-500/50 group"
                    >
                        <div className="w-14 h-14 bg-blue-600 text-white rounded-2xl flex items-center justify-center mb-6 shadow shadow-blue-200 group-hover:rotate-12 transition-transform">
                            <TbEye size={32} />
                        </div>
                ...
                <div className="mb-10">
                    <h2 className="text-3xl font-black text-center text-blue-700 mb-12">How Our System Works</h2>
                    <div className="grid md:grid-cols-3 gap-10">
                        {[
                            ...
                            <motion.div key={i} {...fadeInUp} transition={{delay: i * 0.2}} className="relative text-center group">
                                <div className="text-6xl font-black text-gray-100 absolute -top-10 left-1/2 -translate-x-1/2 group-hover:text-blue-50 transition-colors">{item.step}</div>
                                <div className="relative z-10">
                                    <div className="text-blue-600 text-4xl mb-4 flex justify-center">{item.icon}</div>
                ...
                <div className="grid md:grid-cols-3 gap-8 mb-10">
                    {[
                        ...
                        <motion.div
                            key={index}
                            {...fadeInUp}
                            className=" p-8 rounded-[3rem] shadow border border-gray-500/50 hover:-translate-y-2 transition-all"
                        >
                ...
                <motion.div
                    {...fadeInUp}
                    className=" text-white p-10 md:p-16 rounded-[3rem] border border-gray-500/50 shadow relative overflow-hidden"
                >
                    <div className="relative z-10">
                        <h2 className="text-3xl md:text-4xl font-black mb-10 text-blue-400 text-center md:text-left">Why Choose Our System?</h2>
                        <ul className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {[
                                ...
                                <li key={i} className="flex items-center gap-3 text-gray-400 font-medium group">
                                    <TbCircleCheck className="text-blue-500 shrink-0 group-hover:scale-125 transition-transform" size={24} />
                                    {feature}
                                </li>
                            ))}
                        </ul>
                ...
                >
                    <div className="inline-block p-4 bg-white/90 rounded-full shadow-lg mb-6 animate-bounce">
                    ...
                    <Link 
                        to="/products" 
                        className="bg-blue-600 text-white px-10 py-4 rounded-2xl shadow shadow-blue-100 hover:bg-blue-900 transition-all font-black uppercase text-xs tracking-widest inline-block active:scale-95"
                    >
                        Explore Products
                    </Link>
                </motion.div>
