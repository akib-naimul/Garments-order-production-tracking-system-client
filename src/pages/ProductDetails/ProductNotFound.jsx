      ...
      <div className="min-h-[70vh] flex flex-col justify-center items-center text-center py-20">
        ...
        >
          <button
            ...
            className="flex items-center justify-center gap-2 bg-gray-500 text-white px-8 py-4 rounded-2xl font-bold hover:bg-blue-600 transition-all shadow-lg active:scale-95"
          >
