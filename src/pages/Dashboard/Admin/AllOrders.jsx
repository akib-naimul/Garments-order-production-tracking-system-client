        ...
        <div className=" md:p-5 bg-gray-50 min-h-screen">
            <div className="max-w-7xl mx-auto bg-white rounded-2xl shadow-sm p-6">
                <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                    <div>
                        <h2 className="text-3xl font-black text-blue-600">All Orders</h2>
                    ...
                    <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
                        ...
                        <div className="relative flex-1 md:w-44">
                            ...
                            <select
                                ...
                                className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none bg-white appearance-none cursor-pointer"
                            >
