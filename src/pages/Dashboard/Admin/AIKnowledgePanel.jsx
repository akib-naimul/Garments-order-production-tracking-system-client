                ...
                <div className="flex bg-white rounded-2xl p-1 shadow-sm border border-slate-100 mb-6">
                    <button
                        ...
                        className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl text-sm font-medium transition-all
                            ${activeTab === "qa" ? "bg-blue-500 text-white shadow-sm" : "text-slate-500 hover:text-slate-700"}`}
                    >
                        ...
                        <div className="bg-white rounded-2xl p-5 shadow-sm border border-slate-100">
                            ...
                            <div className="space-y-3">
                                ...
                                <button
                                    onClick={handleAddQA}
                                    disabled={loading}
                                    className="w-full flex items-center justify-center gap-2 bg-blue-500 hover:bg-blue-600 disabled:bg-slate-300 text-white font-medium py-3 rounded-xl transition text-sm"
                                >
