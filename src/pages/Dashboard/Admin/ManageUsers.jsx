      ...
      <div className="py-8">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between mb-10 gap-6">
          <div className="flex items-center gap-4">
            <div className="bg-blue-500 p-4 rounded-3xl text-white shadow-xl shadow-blue-100 ring-4 ring-blue-50">
              <TbUsers size={32} />
            </div>
            <div>
          ...
          <div className="flex flex-wrap items-center gap-4 w-full lg:w-auto">
            ...
            <div className="relative flex-row lg:flex-row-0">
              ...
              <input 
                ...
                className="w-full lg:w-80 pl-12 pr-4 py-3.5 bg-white border border-gray-100 rounded-2xl shadow-sm focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all text-sm font-medium" 
              />
            </div>
            ...
            <div className="bg-white px-6 py-3 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-6">
              ...
              <button 
                onClick={fetchUsers}
                className="p-2.5 hover:bg-gray-50 text-blue-600 rounded-xl transition-all active:rotate-180 duration-500"
                title="Refresh Data"
              >
                <TbRefresh size={24} />
              </button>
