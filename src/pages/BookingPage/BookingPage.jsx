          ...
          <div className="flex-1 p-8 md:p-12">
            <div className="mb-10">
              <h2 className="text-3xl font-black flex items-center gap-3">
                <HiOutlineClipboardList className="text-blue-600" /> Complete Booking
              </h2>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-4">
                <h4 className="text-xs font-black uppercase tracking-[0.2em] text-blue-600 border-b border-blue-100/50 pb-2">1. Personal Information</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full  border border-gray-500/50 p-4 pl-12 rounded-2xl focus:ring-2 focus:ring-blue-500 transition shadow-inner"
                    />
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full border-gray-500/50 border p-4 pl-12 rounded-2xl focus:ring-2 focus:ring-blue-500 transition shadow-inner"
                    />
              ...
              <div className="space-y-4 pt-4">
                <h4 className="text-xs font-black uppercase tracking-[0.2em] text-blue-600 border-b border-blue-100/50 pb-2">2. Communication & Shipping</h4>
                <div className="relative">
              ...
              <button
                type="submit"
                className="w-full bg-blue-700 text-white py-5 rounded-xl font-black uppercase tracking-widest hover:bg-blue-600 transition-all duration-300 shadow-xl active:scale-[0.98] mt-6"
              >
                Place Final Order
              </button>
            </form>
          ...
          <div className="w-full lg:w-80  p-8 border-l border-gray-500/50 flex flex-col">
            ...
            <div className="space-y-6 flex-row">
              <div className=" p-4 rounded-3xl shadow-sm border border-gray-500/50">
                <p className="text-[10px] font-black text-blue-600 uppercase mb-2">Target Product</p>
              ...
              <div className=" p-4 rounded-3xl shadow-sm border border-gray-500/50">
                <p className="text-[10px] font-black text-blue-600 uppercase mb-3">Adjust Quantity</p>
                <input
                  type="number"
                  {...register("quantity")}
                  className="w-full text-center text-2xl font-black py-2 rounded-xl focus:outline-none border-2 border-transparent focus:border-blue-500"
                />
              ...
              <div className="pt-6 space-y-3">
                ...
                <div className="flex justify-between items-center pt-2">
                  ...
                  <span className="text-3xl font-black text-blue-500 tracking-tighter">${watch("total")}</span>
                </div>
              </div>
            </div>

            <div className="mt-10 p-4 bg-blue-300/50 rounded-2xl flex items-center gap-3">
              <HiOutlineCurrencyDollar className="text-blue-700 text-2xl shrink-0" />
              <p className="text-[9px] font-bold text-blue-800 leading-tight uppercase">
