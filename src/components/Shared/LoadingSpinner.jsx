    ...
    >
      <div className="relative flex flex-col items-center">
        ...
        <div className="relative flex items-center justify-center w-16 h-16">
          ...
          {/* Inner solid core */}
          <div className="relative w-8 h-8 bg-blue-500 rounded-lg shadow-lg shadow-blue-200 animate-pulse rotate-45"></div>
        </div>

        {/* Minimal Progress Line */}
        <div className="mt-8 w-48 h-1 bg-gray-100 rounded-full overflow-hidden">
          <div className="w-full h-full bg-blue-500 origin-left animate-progress-line"></div>
        </div>
