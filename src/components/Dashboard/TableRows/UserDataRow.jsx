...
const UserDataRow = ({ user, index, refetchUsers }) => {
  ...
  return (
    <>
      <tr className="hover:bg-blue-50/30 transition-all duration-300 group border-b border-gray-100 last:border-none">
        {/* Serial Number */}
        <td className="px-5 py-5 text-xs font-mono text-gray-400 group-hover:text-blue-600 transition-colors">
        ...
        <td className="px-5 py-5">
          <div className="flex items-center gap-4">
            ...
            <div className="max-w-[150px] truncate">
              <p className="font-bold text-gray-800 leading-tight group-hover:text-blue-700 transition-colors truncate">
