...
import { ShoppingCart, Package, Users, UserCheck } from "lucide-react";
...
const AdminStatistics = () => {
  ...
  // Weekly Chart
  const weeklyChart = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map(
    (day) => ({
      name: day,
      sales: filteredOrders.filter(
        (o) =>
    ...
    <div className="min-h-screen bg-gray-100 p-4 sm:p-6 overflow-x-hidden font-sans">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
        ...
        <StatCard
          ...
          value={`${newUsersCount} / ${totalUsersCount}`}
          subText="User growth"
          icon={Users}
