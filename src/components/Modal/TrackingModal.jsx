    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex justify-center items-center z-50 p-4">
      <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto">
        <div className="bg-blue-500 p-4 sticky top-0 z-10">
          ...
          <p className="text-blue-100 text-xs text-center">Order ID: {order._id}</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-4">
          ...
          <div className="bg-gray-50 p-3 rounded-lg border border-dashed border-gray-300">
            <label className="flex items-center gap-1 text-sm font-bold text-gray-700 mb-2">
              <TbMapPin className="text-blue-600" /> Map Coordinates
            </label>
            <div className="grid grid-cols-2 gap-3">
              <div>
                <input
                  ...
                  className="w-full border border-gray-300 p-2 rounded-lg text-sm outline-none focus:ring-1 focus:ring-blue-500"
                />
              </div>
              <div>
                <input
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              type="submit"
              disabled={uploading}
              className="flex-1 bg-blue-600 text-white font-semibold py-2.5 rounded-lg hover:bg-blue-700 transition-all flex justify-center items-center gap-2"
            >
