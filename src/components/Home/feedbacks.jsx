...
const CustomerFeedback = () => {
    const settings = {
        ...
        customPaging: i => (
            <div className="w-3 h-3 rounded-full  hover:bg-blue-400 transition-all duration-300 border border-transparent dot-active:bg-blue-600 dot-active:w-8"></div>
        )
    };
        ...
        <section className="py-5 overflow-hidden">
            <div className="container mx-auto px-2">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="order-2 lg:order-1">
                        ...
                        >
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <span className="text-sm font-black text-blue-600 uppercase tracking-widest">Success Stories</span>
                            </div>
                            <h2 className="text-2xl md:text-3xl font-black  leading-tight">
                                What Our Global  <span className="text-blue-500 decoration-gray-200">Clients Say</span>
                            </h2>
                        </motion.div>
                            ...
                            <Slider {...settings} className="feedback-slider">
                                {feedbacks.map((fb, i) => (
                                    <div key={i} className="outline-none py-4">
                                        <div className=" backdrop-blur-sm border border-gray-400/40 p-8 md:p-10 rounded-xl shadow-sm">
                                            ...
                                            <p className="text-lg  text-gray-400 font-medium leading-relaxed italic mb-8">
                                                "{fb.comment}"
                                            </p>

                                            <div className="flex items-center gap-4 border-t border-gray-400/40 pt-6">
                                                <div className="w-14 h-14  rounded-full flex items-center justify-center text-xl font-bold shadow shadow-blue-200">
                                                    {fb.name[0]}
                                                </div>
                                                <div>
                                                    ...
                                                    <p className="text-xs text-gray-500 font-semibold">{fb.role} @ <span className="text-blue-600">{fb.company}</span></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    >
                        <div className="absolute  w-[120%] h-[120%] rounded-full -z-10 "></div>
